      ...
      <Modal isOpen={open} onDismiss={toggle}>
        <Wrapper flexDirection="column" p="16px 24px">
          <Box>
            ...
            <StyledNavLink id={`stake-nav-link`} to={'/stake'} isActive={() => history.location.pathname.includes('/stake')}>
              {t('Stake')}
            </StyledNavLink>
            <StyledNavLink id={`stake-nav-link`} to={'/limit'} isActive={() => history.location.pathname.includes('/limit')}>
              {t('Limit')}
            </StyledNavLink>
          </Box>
          <Box>
          ...
          <Box>
            <StyledNavLink
              ...
              onClick={closeModals}
              isActive={() =>
                history.location.pathname.includes('/votes') ||
                history.location.pathname.includes('/add') ||
                history.location.pathname.includes('/remove') ||
                history.location.pathname.includes('/create')
              }
          ...
          <Box>
            <StyledNavLink
              ...
              onClick={closeModals}
              isActive={() =>
                history.location.pathname.includes('/airdrops') ||
                history.location.pathname.includes('/add') ||
                history.location.pathname.includes('/remove') ||
                history.location.pathname.includes('/create')
              }
