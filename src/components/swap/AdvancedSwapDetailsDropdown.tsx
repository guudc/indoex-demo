...
//basically styled-components makes it possible to get the props we intend to pass to a dom element
//like here this element has a prop show which is a boolean
